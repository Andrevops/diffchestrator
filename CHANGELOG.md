...
### Bug Fixes
- Reload open editors when files change on disk
...
### Bug Fixes
- Watch working directory for filesystem changes
...
### Bug Fixes
- Revert to ThemeIcon.File — Uri iconPath rendered nothing
...
### Bug Fixes
- Preserve focus when clicking a terminal tab switches repos
...
### Bug Fixes
- Replace broken codicon syntax in tree item descriptions

## 0.75.0

### Features
- Prefer pull over fetch when safe on startup sync
...
### Bug Fixes
- Prevent stale selection on rapid cross-root terminal switching
