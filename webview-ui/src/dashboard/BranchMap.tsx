...
export default function BranchMap({ entries, onOpenRepo }: Props) {
  ...
  // Sort branches by repo count descending
          ...
          <>
            <div className="branch-group">
              ...
              <div className="branch-pills">
                ...
                {mainRepos.length === 0 && (
                  <span className="section-empty" style={{ padding: 4 }}>
                    None
                  </span>
                )}
              </div>
            ...
            {sortedBranches.map(([branch, repos]) => (
              <div className="branch-group" key={branch}>
                <div className="branch-label">
                  {branch}{" "}
                  <span className="section-badge">{repos.length}</span>
                </div>
                <div className="branch-pills">
                  {repos.map((r) => (
                    <span
